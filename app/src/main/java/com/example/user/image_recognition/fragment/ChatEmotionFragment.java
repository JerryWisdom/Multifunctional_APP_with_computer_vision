...
import com.example.user.image_recognition.adapter.EmotionGridViewAdapter;
import com.example.user.image_recognition.adapter.EmotionPagerAdapter;
import com.example.user.image_recognition.base.BaseFragment;
import com.example.user.image_recognition.base.MyApplication;
import com.example.user.image_recognition.util.EmotionUtils;
import com.example.user.image_recognition.util.Utils;
import com.example.user.image_recognition.util.GlobalOnItemClickManagerUtils;
import com.example.user.image_recognition.widget.IndicatorView;
